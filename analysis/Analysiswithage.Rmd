...
k_range = c(2, 4, 5, 10, 20, 25, 50, 100, 150, 200, 300, 400)
train_error = c()
test_error = c()
...
rf1=randomForest(viewsQuartile3 ~ category+ timePeriod+ definition+ caption+ madeForKids+ + duration+age, data = train, mtry=3, ntree=1000, nodesize = 1)
rf1
